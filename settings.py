...
WELCOME_MESSAGE = os.getenv("WELCOME_MESSAGE", "👋 Добро пожаловать!\n "
                                               "База знаний доступна по ссылке https://leader-id.ru/page/tk-knowledge\n \n "
                                               "Напишите мне ваш вопрос, и команда департамента развития сети ответит в ближайшее время.")
